    ...
    <div class="modal-content">
      ...
      <div class="card card-primary card-outline">
                    ...
                    <fieldset class="border border-info p-1">
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-6 col-md-3">
                          ...
                          <input class="form-control" type="number" title="you can change the price if you may"
                            v-model="product.price" ref="price" required="" placeholder="Enter Price">
                        ...
                        <div class="col-6 col-md-3">
                          ...
                          <input type="number" v-model="cartItem.quantity" required="" min="1" class="form-control"
                            ref="quantity" placeholder="How many pc(s)">
                          <label v-if="product.stock != undefined" class="small text-danger">Remaining {{ product.stock }}
                            pc(s)</label>
                        </div>
                      </div>
                        ...
                        <tbody id="body">
                          <tr draggable
                            ...
                            <td @input="editItemOnCart($event, item, index, 'price', item.index)"
                              @keypress.enter.prevent="" contenteditable=""
                              class="text-center p-1 small text-capitalize">{{ item.price }} </td>
        ...
        <div class="modal-footer border pt-0 pb-1 border-top-0 border-primary">
          ...
          <button type="submit" @click.prevent="processCheckout" data-toggle="modal" data-target="#addProductComponent"
            :disabled="cart.length == 0" class="btn btn-info">Checkout</button>
        </div>
      </div>
    </div>
