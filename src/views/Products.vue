                ...
                <div class="container-fluid">
                    <div class="card card-success card-outline m-auto ">
                        <div class="card-header">
                            <h5 class="card-title mt-1 m-2"> Summary</h5>
                        </div>
                            ...
                            <div class="card-body box-profile">
                                <div class="row container  mb-3 mt-3">
                                    <div class="col-lg-12 col-sm-12 mb-3 ">
                                        <div class="card-header">
                                            <h5 class="card-title mt-1 m-2">{{ title }}</h5>
                                        </div>
...
import ShowProductsComponent from '@/components/product/ShowProductsComponent.vue';
import AddProductComponent from '@/components/product/AddProductComponent.vue';
import AddPurchaseComponent from '@/components/product/AddPurchaseComponent.vue';
