<template>
    <div>
                        ...
                        <div class="card-body box-profile">
                            <div class="row container  mb-2 mt-4">
                                <div class="col-lg-3 col-sm-6 mb-3 text-center">
                                    <div class="circle mb-lg-4">
                                        <div class="inner-circle">
                                            <p class="circle-text">{{ users.length }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6 mb-3 text-center">
                                    <div class="circle mb-lg-4">
                                        <div class="inner-circle">
                                            <p class="circle-text">{{ regular.length }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6 mb-3 text-center">
                                    <div class="circle mb-lg-4">
                                        <div class="inner-circle">
                                            <p class="circle-text">{{ admins.length }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-sm-6 mb-3 text-center">
                                    <div class="circle mb-lg-4">
                                        <div class="inner-circle">
                                            <p class="circle-text">{{ super_admins.length }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="row container  mb-3 mt-3">
                                    <div class="col-lg-12 col-sm-12 mb-3 ">
                                        ...
                                        <ul class="products-list product-list-in-card pl-2 pr-2">
                                            <li v-if="loading == false"
                                                v-for="user in $root.myFilter(users, search).slice(0, 5)" class="item">
                                                <div class="product-img">
                                                    <img v-bind:src="'img/user.png'" alt="user Image"
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h3 href="javascript:void(0)" class="users-list-name">
                                                        {{ user.names }} </h3>
                                                    <span class="users-list-date">
                                                        {{ user.number }}
                                                    </span>
                                    ...
                                    <div class="col-lg-12 col-sm-12 mb-3 ">
                                        ...
                                        <div class="card-body box-profile">
                                            ...
                                            <ul class="products-list product-list-in-card pl-2 pr-2">
                                                ...
                                                <li v-if="loading == false" v-for="user in admins.concat(super_admins)"
                                                    class="item">
                                                    <div class="product-img">
                                                        <img v-bind:src="'img/user.png'" alt="user Image"
                                                            class="rounded-circle">
        ...
        <div style="position: fixed; bottom: 25px; right: 25px">
            <button type="button" @click="addComponent" class="btn btn-success  rounded-circle" title="Add new user"
                id="add" data-toggle="modal" data-target="#addUser"><i class="fa fa-plus"></i> </button>
        </div>
...
import ShowUsersComponent from '@/components/user/ShowUsersComponent.vue';
